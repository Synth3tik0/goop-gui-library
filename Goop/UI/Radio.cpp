...
Radio::Radio(const wchar_t *text, Base *parent)
{
	...
	m_handle = (HWND)CreateWindowExW(0, L"BUTTON", L"", WS_CHILD | BS_AUTORADIOBUTTON, CW_USEDEFAULT, CW_USEDEFAULT, CW_USEDEFAULT, CW_USEDEFAULT, m_proxy->m_handle, (HMENU)m_id, instanceHandle, 0);
